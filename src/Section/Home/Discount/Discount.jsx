    ...
    return (
        <div className='py-12'>
            <div className='container mx-auto'>
                <h2 className='text-sectionTitle fnt text-4xl font-bold text-center py-4 pb-12'>HARGA DISKON KHUSUS!</h2>
                <div className='flex flex-col-reverse md:flex-row items-center justify-between gap-4'>
                    <div>
                        <h2 className='text-4xl text-textBlue fnt font-bold'>Diskon Khusus Spesial Hari (...)!!
                        20%</h2>
                        <h6 className='text-xl text-my-pink fnt font-bold pt-4'>Eams Sofa Compact</h6>
                        <p className='text-[#B7BACB] text-lg font-[400] py-8'>
                        Eksklusif & Terbatas! Amankan Harga Spesial Ini Sekarang!
                        </p>
