    ...
    return (
        <div>
            ...
            <div className="container mx-auto py-24 grid grid-cols-3">
                                    ...
                                    <div className='flex w-full md:justify-between md:flex-row flex-col px-8'>
                                        <div className='flex flex-col'>
                                            ...
                                            <div className='flex items-center gap-2 my-2'>
                                                ...
                                                <input type="text" value={item.adet} className="border border-gray-300 px-2  w-10 focus:outline-none focus:border-[#fb2e86] my-1" />
                                                <button className='border border-gray-300 flex justify-center items-center bg-gray-200 text-black h-6 w-6 rounded'
                                                    onClick={() => handleArttir(item.id)}><FaPlus size="12px" /></button>
                                            </div>
                                            <div className='fnt text-textBlue text-lg'>{convertCurrency(item.price)}</div>
                                        </div>
                                        <div>
                ...
                <CartTotal total={toplam.toFixed(2)} length={allCartItems.cart.length} onClear={handleAllClear} products={allCartItems.cart} />
                </div>
            </div>
